...
// Matches the fixed category set real showcase posts are created with
// (see components/ShowcaseComposer.js) exactly — same casing/spelling —
// so filtering works for real posts.
export const showcaseFilters = ["All", "Web", "Mobile", "Design", "Data", "Other"];
...
export const showcaseItems = [
  ...
  },
  {
    ...
    author: "Chenda Mao",
    meta: "IT • Year 1",
    title: "Predicting exam scores with a simple linear model",
    excerpt:
      "A first attempt at applying regression to our department's own study-hours survey data.",
    tags: ["Python", "Pandas"],
    category: "Data & AI",
    likes: 14,
    comments: 2,
  ...
  },
  {
    ...
    author: "Ratanak Chea",
    meta: "IT • Year 4",
    title: "Setting up a small VLAN for the capstone lab",
    excerpt:
      "Segmenting traffic between three project teams sharing one lab switch.",
